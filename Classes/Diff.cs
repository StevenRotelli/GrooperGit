...
namespace GrooperGit
{
    ...
    /// <remarks>Git Staging allows you to prepare changes for a commit, helping you organize modifications and facilitating code review.
    /// Learn more about Git Staging <a href="https://git-scm.com/docs/git-stage">here</a>.</remarks>
    [DataContract, IconResource("Stage")]
    public class Diff : GitCommand
    {
        /// <inheritdoc/>
        protected override void Execute(GrooperNode Item)
        {
            GitProject parentProject = (GitProject)Item.ParentProject;
            _ = parentProject.Repository.Diff(Item);
        }
